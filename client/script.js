...
var $author$project$Main$CommandPosted = function (a) {
	return {$: 'CommandPosted', a: a};
};
...
var $author$project$Main$remoteCommandToJson = function (remoteCommand) {
...
var $author$project$Main$postCommand = F2(
	function (remoteCommand, server_ip) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Main$remoteCommandToJson(remoteCommand)),
				expect: $elm$http$Http$expectWhatever($author$project$Main$CommandPosted),
				url: 'http://' + server_ip
			});
	});
...
var $author$project$Main$Brightness = function (a) {
	return {$: 'Brightness', a: a};
};
var $author$project$Main$Netflix = {$: 'Netflix'};
var $author$project$Main$PostCommand = function (a) {
	return {$: 'PostCommand', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$PostCommand($author$project$Main$Shutdown))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('monitor brightness')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(model.brightness)),
								$elm$html$Html$Events$onInput(
								function (newValue) {
									return $author$project$Main$PostCommand(
										$author$project$Main$Brightness(newValue));
								})
							]),
						_List_Nil)
					])),
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$PostCommand($author$project$Main$Netflix))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('netflix')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
